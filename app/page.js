    ...
    <>
      ...
      <div className="strip">
        <div className="container">
          ...
          <span className="strip-divider" />
          <span className="strip-item">Energy · AI · Life Sciences</span>
          <span className="strip-divider" />
      ...
      <section className="block" id="thesis">
        <div className="container">
          <span className="section-num reveal">01 — Thesis</span>
      ...
      <section className="block" id="process">
        <div className="container">
          <span className="section-num reveal">02 — Process</span>
          ...
          <div className="process-grid reveal">
            ...
            <div className="process-step">
              ...
              <p className="process-desc">Disciplined exit planning aligned to the company's path to public markets or strategic outcome.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="block" id="focus">
        <div className="container">
          <span className="section-num reveal">03 — Focus</span>
          <h2 className="section-title reveal">Where we look, and <em>where we don't</em>.</h2>
          <p className="section-lede reveal">
            ICC concentrates capital where the general partner has direct operating and transaction experience. Other categories — however attractive in the abstract — are declined.
          </p>
      ...
      <section className="block structure-block" id="structure">
        <div className="container">
          <span className="section-num reveal">04 — Structure</span>
      ...
      <section className="cta-block" id="access">
        <div className="container-narrow">
          <span className="section-num reveal">05 — Inquiry</span>
